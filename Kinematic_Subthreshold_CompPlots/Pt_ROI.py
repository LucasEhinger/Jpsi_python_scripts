...
# dir=".ROI"
# dir=".JPsi.JPsi_ROI"
# histname="jpsi_perp_ROI"
dir=".Proton.Proton_ROI"
histname="p_perp_ROI"
...
if pTCut!="":
    filepath+="/pTCuts/"+pTCut+f"_{pTRegion}/"
...
plt.ylabel("Counts")
# plt.xlabel(r"$J/\psi$ $p_t$ [GeV]")
plt.xlabel(r"$Proton$ $p_t$ [GeV]")
plt.xlim(xmin,xmax)
xmin,xmax,ymin,ymax=plt.axis()
# plt.ylim(ymin,ymax*1.2)
placeText(r"$E_{\gamma}>$"+Egamma_thresh.replace("p",".")+" GeV",loc=1)
plt.savefig(f"../figures/p2_preB03_Emiss1/subthreshold/pT/p_pT_ROI_{version}_pT{pTCut}_{pTRegion}_{tracks}_mixed.pdf")
plt.show()
