...
sidebandRegion=r"$3<m(e^+e^-)<3.2$"
if sideband=="Sidebands":
    sidebandRegion = ""

if pTCut=="":
    placeText(sidebandRegion,loc=1,yoffset=-25)
else:
    placeText(sidebandRegion
...
placeText("C",loc=1)
plt.xlabel(r"$p_p$ [GeV]")

plt.savefig(f"../figures/p2_preB03_Emiss1/AComp/p_p_ROI_fitted_{version}_pT{pTCut}_{tracks}_mixed.pdf")
plt.show()
